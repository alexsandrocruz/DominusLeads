    ...
    <Shell>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button className="gap-2" onClick={() => setLocation("/admin/adv-clientes-inssstatus/create")}>
            <Plus className="size-4" />
            New advClientesINSSStatus
          </Button>
        </div>

        <AdvClientesINSSStatusList onEdit={(item) => setLocation(`/admin/adv-clientes-inssstatus/${item.id}/edit`)} />
      </div>
    </Shell>
  );
}
