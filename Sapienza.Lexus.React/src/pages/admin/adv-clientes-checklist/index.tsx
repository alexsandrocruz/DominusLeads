    ...
    <Shell>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button className="gap-2" onClick={() => setLocation("/admin/adv-clientes-checklist/create")}>
            <Plus className="size-4" />
            New advClientesChecklist
          </Button>
        </div>

        <AdvClientesChecklistList onEdit={(item) => setLocation(`/admin/adv-clientes-checklist/${item.id}/edit`)} />
      </div>
    </Shell>
  );
}
