    ...
    <Shell>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button className="gap-2" onClick={() => setLocation("/admin/adv-tarefas-atualizacoes/create")}>
            <Plus className="size-4" />
            New advTarefasAtualizacoes
          </Button>
        </div>

        <AdvTarefasAtualizacoesList onEdit={(item) => setLocation(`/admin/adv-tarefas-atualizacoes/${item.id}/edit`)} />
      </div>
    </Shell>
  );
}
